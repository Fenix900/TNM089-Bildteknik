function [Z_red, Z_green, Z_blue]  = zMake_pick(images, imageAmount, sampleAmount, pixelSamples, paintRed)
    ...
    for i = 1:imageAmount
        ...
        % Fr.o.m. bild nr 2:
        % Hindra pos.-dubletter genom att göra dubletters rgbSum-värden jättehögt,
        % och därmed forcera jättehöga dist - då bortses dubletterna
        if i~=1
